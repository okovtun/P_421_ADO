...
TODO:
1. Реализовать и протестировать формы добавления/изменения на вкладках 'Groups', 'Directions' и 'Disciplines';
2. На вкладке 'Teachers' реализовать изменение существующих преподавателей;
3. При нажатии ПКМ в заголовке таблицы на вкладках 'Students' и 'Teachers' должно появляться контекстное меню,
   позволяющее выбирать отображаемые столюцы;

DONE:
1. При нажатии кнопки OK после редактирования студента, отредактированный студент должен подсвечиваться в таблице
